...
#            context_tgttgt.append(tgtline)
            ...
            src_write_tcs=' <context> '.join([*[true_tgt(sent) for sent in context_tgt],*[true_src(sent) for sent in context_src],srcline])
            tgt_write=' <context> '.join([*context_tgttgt,tgtline])
            tgt_write_tcs=' <context> '.join([*[true_tgt(sent) for sent in context_tgttgt],tgtline])
